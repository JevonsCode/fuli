...
test('CLI invocation recognizes help, version, lifecycle, setup, update, uninstall, and migrate as command boundaries', () => {
  ...
  assert.equal(parseCliInvocation(['update', '--yes']).command, 'update');
